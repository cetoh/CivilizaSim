...
public class NameGenerator
{
    ...
    private static final String FEMALE_NAMES_FILE = "dist.female.first.txt";

    private static final String MALE_NAMES_FILE = "dist.male.first.txt";

    private static final String SURNAMES_FILE = "dist.all.last.txt";
    ...
    /**
     * Generate a single name of either {@link com.toh.us.CivilizaSim.GameObjects.People.NameGen.Gender}
     *
    ...
    /**
     * Generate a single name of the specified {@link com.toh.us.CivilizaSim.GameObjects.People.NameGen.Gender}
     *
